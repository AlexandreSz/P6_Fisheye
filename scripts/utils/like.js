...
function manageLikes() {
  ...
  const mediaLikesNumberElements = document.querySelectorAll('.like_number')
...
function likeDislike(mediaHeart, pageLikesElement) {
  const like1 = mediaHeart.parentElement.querySelector('.like_number').innerHTML

  const likes = mediaHeart.parentElement.querySelector('.like_number')
